...
pub async fn count_message_tokens_v1_messages_count_tokens_post(configuration: &configuration::Configuration, count_tokens_request: models::CountTokensRequest) -> Result<models::CountTokensResponse, Error<CountMessageTokensV1MessagesCountTokensPostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CountMessageTokensV1MessagesCountTokensPostError> = serde_json::from_str(&content).ok();
...
pub async fn create_message_v1_messages_post(configuration: &configuration::Configuration, messages_request: models::MessagesRequest) -> Result<models::MessageResponse, Error<CreateMessageV1MessagesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
