...
pub async fn health_check_health_get(configuration: &configuration::Configuration, ) -> Result<std::collections::HashMap<String, String>, Error<HealthCheckHealthGetError>> {
...
pub async fn health_liveness_health_liveness_get(configuration: &configuration::Configuration, ) -> Result<String, Error<HealthLivenessHealthLivenessGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<HealthLivenessHealthLivenessGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn health_readiness_health_readiness_get(configuration: &configuration::Configuration, ) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<HealthReadinessHealthReadinessGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<HealthReadinessHealthReadinessGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
