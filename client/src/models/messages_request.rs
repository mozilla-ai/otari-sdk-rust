...
pub struct MessagesRequest {
    #[serde(rename = "cache_control", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "model")]
    pub model: String,
    #[serde(rename = "stop_sequences", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl MessagesRequest {
    ...
    pub fn new(max_tokens: i32, messages: Vec<std::collections::HashMap<String, serde_json::Value>>, model: String) -> MessagesRequest {
        MessagesRequest {
            cache_control: None,
            guardrails: None,
            max_tokens,
