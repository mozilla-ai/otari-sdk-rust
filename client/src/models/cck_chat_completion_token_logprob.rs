...
pub struct CckChatCompletionTokenLogprob {
    #[serde(rename = "token")]
    pub token: String,
...
impl CckChatCompletionTokenLogprob {
    pub fn new(token: String, logprob: f64, top_logprobs: Vec<models::CckTopLogprob>) -> CckChatCompletionTokenLogprob {
