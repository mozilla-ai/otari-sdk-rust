...
pub struct MrToolSearchToolSearchResultBlock {
...
impl MrToolSearchToolSearchResultBlock {
    pub fn new(tool_references: Vec<models::MrToolReferenceBlock>, r#type: Type) -> MrToolSearchToolSearchResultBlock {
