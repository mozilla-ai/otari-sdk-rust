...
impl MrTextBlockCitationsInner {
    pub fn new(cited_text: String, document_index: i32, end_char_index: i32, start_char_index: i32, r#type: Type, end_page_number: i32, start_page_number: i32, end_block_index: i32, start_block_index: i32, encrypted_index: String, url: String, search_result_index: i32, source: String) -> MrTextBlockCitationsInner {
