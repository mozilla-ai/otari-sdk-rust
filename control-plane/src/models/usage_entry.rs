...
impl UsageEntry {
    ...
    pub fn new(api_key_id: Option<String>, completion_tokens: Option<i32>, cost: Option<f64>, endpoint: String, error_message: Option<String>, id: String, model: String, prompt_tokens: Option<i32>, provider: Option<String>, status: String, timestamp: String, total_tokens: Option<i32>, user_id: Option<String>) -> UsageEntry {
        UsageEntry {
            api_key_id,
            completion_tokens,
            cost,
