...
pub struct MrBashCodeExecutionToolResultError {
...
impl MrBashCodeExecutionToolResultError {
    pub fn new(error_code: ErrorCode, r#type: Type) -> MrBashCodeExecutionToolResultError {
        MrBashCodeExecutionToolResultError { error_code, r#type }
    }
}
///
