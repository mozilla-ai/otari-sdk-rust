...
pub struct MrTextEditorCodeExecutionCreateResultBlock {
...
impl MrTextEditorCodeExecutionCreateResultBlock {
    pub fn new(is_file_update: bool, r#type: Type) -> MrTextEditorCodeExecutionCreateResultBlock {
