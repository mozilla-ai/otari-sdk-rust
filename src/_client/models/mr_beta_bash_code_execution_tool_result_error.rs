...
pub struct MrBetaBashCodeExecutionToolResultError {
...
impl MrBetaBashCodeExecutionToolResultError {
    pub fn new(error_code: ErrorCode, r#type: Type) -> MrBetaBashCodeExecutionToolResultError {
        MrBetaBashCodeExecutionToolResultError { error_code, r#type }
    }
}
///
