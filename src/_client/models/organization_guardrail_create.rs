...
pub struct OrganizationGuardrailCreate {
    ...
    /// A guardrail definition of this organization for Otari to build and run itself, instead of calling a profile on a guardrails service. Mutually exclusive with url and credential, which name a service
    #[serde(
        rename = "definition_id",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub definition_id: Option<Option<uuid::Uuid>>,
