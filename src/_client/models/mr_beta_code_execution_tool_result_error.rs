...
pub struct MrBetaCodeExecutionToolResultError {
...
impl MrBetaCodeExecutionToolResultError {
    pub fn new(error_code: ErrorCode, r#type: Type) -> MrBetaCodeExecutionToolResultError {
        MrBetaCodeExecutionToolResultError { error_code, r#type }
    }
}
///
