...
pub struct MrBetaToolSearchToolResultError {
...
impl MrBetaToolSearchToolResultError {
    pub fn new(error_code: ErrorCode, r#type: Type) -> MrBetaToolSearchToolResultError {
