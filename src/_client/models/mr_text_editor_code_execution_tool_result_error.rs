...
pub struct MrTextEditorCodeExecutionToolResultError {
...
impl MrTextEditorCodeExecutionToolResultError {
    pub fn new(error_code: ErrorCode, r#type: Type) -> MrTextEditorCodeExecutionToolResultError {
