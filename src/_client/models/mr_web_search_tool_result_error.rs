...
pub struct MrWebSearchToolResultError {
...
impl MrWebSearchToolResultError {
    pub fn new(error_code: ErrorCode, r#type: Type) -> MrWebSearchToolResultError {
        MrWebSearchToolResultError { error_code, r#type }
    }
}
///
