...
/// struct for typed errors of method [`usage_count_usage`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageCountUsageError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_delete_usage_rows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageDeleteUsageRowsError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_ingest_external_usage`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageIngestExternalUsageError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_list_in_flight`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageListInFlightError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_list_usage`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageListUsageError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_set_usage_price_rows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageSetUsagePriceRowsError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_usage_series`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageUsageSeriesError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`usage_usage_summary`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UsageUsageSummaryError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}
...
pub async fn usage_count_usage(
...
) -> Result<models::UsageCount, Error<UsageCountUsageError>> {
    ...
    let uri_str = format!("{}/api/v1/usage/count", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageCountUsageError> = serde_json::from_str(&content).ok();
...
pub async fn usage_delete_usage_rows(
    configuration: &configuration::Configuration,
    usage_delete_request: models::UsageDeleteRequest,
) -> Result<models::UsageDeleteResult, Error<UsageDeleteUsageRowsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageDeleteUsageRowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn usage_ingest_external_usage(
    configuration: &configuration::Configuration,
    external_events_request: models::ExternalEventsRequest,
) -> Result<models::ExternalIngestResult, Error<UsageIngestExternalUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_external_events_request = external_events_request;

    let uri_str = format!("{}/api/v1/usage/external-events", configuration.base_path);
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageIngestExternalUsageError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn usage_list_in_flight(
    configuration: &configuration::Configuration,
) -> Result<models::InFlightResponse, Error<UsageListInFlightError>> {
    let uri_str = format!("{}/api/v1/usage/in-flight", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageListInFlightError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn usage_list_usage(
    ...
    skip: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<models::UsageEntry>, Error<UsageListUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_start_date = start_date;
    let p_query_end_date = end_date;
    let p_query_user_id = user_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageListUsageError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn usage_set_usage_price_rows(
    configuration: &configuration::Configuration,
    usage_set_price_request: models::UsageSetPriceRequest,
) -> Result<models::UsageSetPriceResult, Error<UsageSetUsagePriceRowsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_usage_set_price_request = usage_set_price_request;

    let uri_str = format!("{}/api/v1/usage/set-price", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageSetUsagePriceRowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn usage_usage_series(
    configuration: &configuration::Configuration,
    group_by: &str,
    start_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    end_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    workspace_id: Option<&str>,
    bucket: Option<&str>,
) -> Result<models::UsageGroupedSeries, Error<UsageUsageSeriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/api/v1/usage/series", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageUsageSeriesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn usage_usage_summary(
    configuration: &configuration::Configuration,
    start_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    end_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    user_id: Option<Vec<String>>,
...
) -> Result<models::UsageSummary, Error<UsageUsageSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_start_date = start_date;
    let p_query_end_date = end_date;
    let p_query_user_id = user_id;
    ...
    let uri_str = format!("{}/api/v1/usage/summary", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UsageUsageSummaryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
