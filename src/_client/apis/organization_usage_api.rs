...
/// struct for typed errors of method [`organization_usage_count_organization_usage`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationUsageCountOrganizationUsageError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organization_usage_list_organization_usage`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationUsageListOrganizationUsageError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organization_usage_organization_usage_series`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationUsageOrganizationUsageSeriesError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organization_usage_organization_usage_summary`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationUsageOrganizationUsageSummaryError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}
...
pub async fn organization_usage_count_organization_usage(
...
) -> Result<models::UsageCount, Error<OrganizationUsageCountOrganizationUsageError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationUsageCountOrganizationUsageError> =
...
pub async fn organization_usage_list_organization_usage(
    configuration: &configuration::Configuration,
    start_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    end_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    user_id: Option<Vec<String>>,
    ...
    skip: Option<i32>,
    limit: Option<i32>,
) -> Result<Vec<models::UsageEntry>, Error<OrganizationUsageListOrganizationUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_start_date = start_date;
    let p_query_end_date = end_date;
    let p_query_user_id = user_id;
    ...
    let uri_str = format!("{}/api/v1/organizations/me/usage", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationUsageListOrganizationUsageError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn organization_usage_organization_usage_series(
    configuration: &configuration::Configuration,
    group_by: &str,
    start_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    end_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    workspace_id: Option<&str>,
    bucket: Option<&str>,
) -> Result<models::UsageGroupedSeries, Error<OrganizationUsageOrganizationUsageSeriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationUsageOrganizationUsageSeriesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn organization_usage_organization_usage_summary(
    configuration: &configuration::Configuration,
    start_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    end_date: Option<chrono::DateTime<chrono::FixedOffset>>,
    user_id: Option<Vec<String>>,
...
) -> Result<models::UsageSummary, Error<OrganizationUsageOrganizationUsageSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_start_date = start_date;
    let p_query_end_date = end_date;
    let p_query_user_id = user_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationUsageOrganizationUsageSummaryError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
