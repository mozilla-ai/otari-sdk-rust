...
/// struct for typed errors of method [`models_get_model`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModelsGetModelError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`models_list_discoverable_models`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModelsListDiscoverableModelsError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`models_list_model_metadata`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModelsListModelMetadataError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`models_list_models`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModelsListModelsError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// Get details for a specific model.
pub async fn models_get_model(
    configuration: &configuration::Configuration,
    model_id: &str,
) -> Result<models::ModelObject, Error<ModelsGetModelError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ModelsGetModelError> = serde_json::from_str(&content).ok();
...
pub async fn models_list_discoverable_models(
    configuration: &configuration::Configuration,
    refresh: Option<bool>,
) -> Result<models::DiscoverableModelsResponse, Error<ModelsListDiscoverableModelsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_refresh = refresh;

    let uri_str = format!("{}/api/v1/models/discoverable", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ModelsListDiscoverableModelsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn models_list_model_metadata(
    configuration: &configuration::Configuration,
) -> Result<models::ModelMetadataResponse, Error<ModelsListModelMetadataError>> {
    let uri_str = format!("{}/api/v1/models/metadata", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ModelsListModelMetadataError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn models_list_models(
    configuration: &configuration::Configuration,
    provider: Option<&str>,
) -> Result<models::ModelListResponse, Error<ModelsListModelsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ModelsListModelsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
