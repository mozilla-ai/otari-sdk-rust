...
pub async fn list_usage_v1_usage_get(configuration: &configuration::Configuration, start_date: Option<chrono::DateTime<chrono::FixedOffset>>, end_date: Option<chrono::DateTime<chrono::FixedOffset>>, user_id: Option<&str>, skip: Option<i32>, limit: Option<i32>) -> Result<Vec<models::UsageEntry>, Error<ListUsageV1UsageGetError>> {
